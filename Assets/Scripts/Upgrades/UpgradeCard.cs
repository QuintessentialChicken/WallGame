...
namespace Upgrades
{
    ...
    {
        [SerializeField] private UpgradeInfo scriptableObject;

        [Header("__________ In-Prefab References __________")] [SerializeField]
        private TextMeshProUGUI title;

        [SerializeField] private TextMeshProUGUI subtitle;
        [SerializeField] private TextMeshProUGUI cooldown;
        [SerializeField] private TextMeshProUGUI description;
        [SerializeField] private Image farbverlauf;
        [SerializeField] private Image backgroundImage;
        [SerializeField] private Image glowImage;
        [SerializeField] private Image foregroundImage;
        [SerializeField] private Image hintergrundstruktur;
        [SerializeField] private Image border;

        [Header("__________ Coloring __________")] [SerializeField]
        private ColorSettings commonColorScheme;

        [SerializeField] private ColorSettings rareColorScheme;
        [SerializeField] private ColorSettings epicColorScheme;
        ...
        [Header("__________ Other Stuff __________")] [SerializeField]
        private float descriptionLineHeight;

        [SerializeField] private float cooldownVertOffset;
        ...
        public void Update()
        {
            transform.rotation = Quaternion.Euler(2 * Mathf.Cos(Time.time), 2 * Mathf.Sin(Time.time),
                Mathf.Cos(Time.time + 3.14f));
        }
